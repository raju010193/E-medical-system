...
<% String adminMessage=(String)request.getAttribute("patientMessage");
        ...
        <%
        ArrayList<FormBeans> profile=(ArrayList<FormBeans>)request.getAttribute("medicine");
        ...
        <div class="w3-half">
            <div class="w3-card white">
                <div class="w3-container w3-indigo">
                    <h3>Available Branch:<%=rfb.getHospitalBranch()%></h3>
                </div>
                <div class="w3-container">
                    <h3 class="w3-text-indigo">Medicine Name</h3>
                    <p><%=rfb.getMedicineName()%></p>
                </div>
                <ul class="w3-ul w3-border-top">
                    <li>
                        <h3>Manufacturing Company</h3>
                        <p><%=rfb.getMedicineCompany()%></p>
                    </li>
                    <li>
                        <h3>Manufacturing Date</h3>
                        <p><%=rfb.getManufacturingDate()%></p>
                    </li>
                    <li>
                        <h3>Expire Date</h3>
                        <p><%=rfb.getExpireDate()%></p>
                    </li>
                    <li>
                        <h3>Company label</h3>
                        <p><%=rfb.getLableName()%></p>
                    </li>
                </ul>
