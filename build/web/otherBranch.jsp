...
<div class="w3-row-padding">
           ...
           <div class="w3-table w3-center" >
               ...
               <table class="w3-table-all">
                   <tbody>
                       <tr class="w3-teal" ><th>Medicine Name</th><th>Medicine Company</th><th>City</th><th>MFD</th><th>Expire Date</th><th> Suggested To </th></tr>
   
     
        <%
        ArrayList<FormBeans> history=(ArrayList<FormBeans>)request.getAttribute("otherBranch");
...
%>
                   ...
                   <tr>
                       <td><%=rfb.getMedicineName()%></td>
                       <td> <%=rfb.getMedicineCompany()%></td>
                        <td><%=rfb.getHospitalBranch()%></td>
                         <td><%=rfb.getManufacturingDate()%></td>
                          <td><%=rfb.getExpireDate()%></td>
                    <td><%=rfb.getLableName()%></td>
