<%-- 
    Document   : index
    Created on : Oct 6, 2016, 8:20:08 PM
    Author     : pavan
--%>
...
<% String adminMessage=(String)request.getAttribute("patientMessage");
        ...
        <%
        ArrayList<FormBeans> history=(ArrayList<FormBeans>)request.getAttribute("history");
        ...
        <div class="w3-half">
            <div class="w3-card white">
                <div class="w3-container w3-indigo">
                    <h3>Slot Book Date: <%=rfb.getBookDate()%></h3>
                </div>
                <div class="w3-container">
                    <h3 class="w3-text-indigo">Patient Name</h3>
                    <p><%=rfb.getPatientName()%></p>
                </div>
                <ul class="w3-ul w3-border-top">
                    <li>
                        <h3>Problem</h3>
                        <p><%=rfb.getProblemType()%></p>
                    </li>
                    <li>
                        <h3>Patient Age</h3>
                        <p><%=rfb.getPatientAge()%></p>
                    </li>
                    <li>
                        <h3>Department</h3>
                        <p><%=rfb.getPatientDepartment()%></p>
                    </li>
                    
                </ul>
                        <div class="w3-container w3-teal  w3-large"><span class="w3-teal w3-right"><%= rfb.getStatus()%></span></div>
            </div>
        </div>
<%}%>
</div>
...
<div id="id01"class="modal w3-row-padding">
    ...
    <div class="w3-form">
     ...
     <div class="w3-col m3">
        ...
        <label class="w3-label"><i class="fa fa-time"></i>   </label>
    </div>
      <div class="w3-col m3" >
