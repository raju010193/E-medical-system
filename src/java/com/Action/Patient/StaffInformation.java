...
public class StaffInformation extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ArrayList<FormBeans> staffInformation = new PatientDao().StaffInformation(userName);

            if (!staffInformation.isEmpty()) {
                
                System.out.println("===================");
                request.setAttribute("staffInformation", staffInformation);
                path = "./staffInformation.jsp";
            } else {
                request.setAttribute("patientMessage", "Staff Information Not Found");
